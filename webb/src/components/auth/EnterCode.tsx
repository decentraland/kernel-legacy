...
export function EnterCode(props: { summary: AuthStatusSummary; setVerificationCode: (code: string) => any }) {
  return (
    <SingleFieldSubmitForm
      title='Log in'
      subtitle='Please enter the 4-digit code that was sent to your email'
      error={
        props.summary === 'Invalid verification code' ? 'It looks like that code is invalid, please try again' : ''
      }
