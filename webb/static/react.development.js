...
*/
                         ...
                         if (
                           ...
                           try {
                             do {
                               ...
                               firstCallbackNode !== null &&
                               firstCallbackNode.priorityLevel ===
                                 ImmediatePriority
                             )
                           } finally {
                       ...
                       function unstable_scheduleCallback(
                         ...
                         if (
                           ...
                           expirationTime =
                             startTime + deprecated_options.timeout
                         } else {
                           switch (currentPriorityLevel) {
                             case ImmediatePriority:
                               expirationTime =
                                 startTime + IMMEDIATE_PRIORITY_TIMEOUT
                               break
                             case UserBlockingPriority:
                               expirationTime =
                                 startTime + USER_BLOCKING_PRIORITY
                               break
                             case IdlePriority:
                       ...
                       var requestAnimationFrameWithTimeout = function(
                         ...
                         rAFID = localRequestAnimationFrame(function(
                           timestamp
                         ) {
                       ...
                       if (globalValue && globalValue._schedMock) {
                         ...
                         if (typeof console !== 'undefined') {
                           ...
                           if (
                             typeof localCancelAnimationFrame !== 'function'
                           ) {
                             console.error(
                         ...
                         function wrapped() {
                           ...
                           try {
                             ...
                             if (!hasRun) {
                               ...
                               wrappedInteractions.forEach(function(
                                 interaction
                               ) {
                                 interaction.__count--
