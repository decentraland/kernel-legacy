import { Vector3, Entity, Transform, BoxShape, engine, OnClick, OnPointerDown, OnPointerUp, Material, Color3, Billboard, TextShape, Camera, AnimationState, GLTFShape, Animator, Input, log, SphereShape, IEntity, Pointer } from 'decentraland-ecs/src'
...
// button down event
input.subscribe("BUTTON_DOWN", Pointer.CLICK, true, e => {
  log("button A Down", e)
...
// button up event
input.subscribe("BUTTON_UP", Pointer.CLICK, true, e => {
  log("button A Up", e)
