...
import { MVector3, ReadOnlyVector3, ReadOnlyQuaternion, MVector2, ReadOnlyVector2 } from '@dcl/utils/dist/math'
import { worldToGrid, gridToWorld, parseParcelPosition } from '@dcl/utils/dist/scene/parcel'
import { Observable } from '@dcl/utils/dist/Observable'
import { ILand } from '@dcl/utils/dist/BagOfThings'
...
export const lastPlayerPosition = new MVector3()
...
export function initializeUrlPositionObserver() {
  ...
  const gridPosition = MVector2.Zero()
...
export function getWorldSpawnpoint(land: ILand): MVector3 {
