...
export const PASSPORT_QUERY = '[Query] Passport'
export const PASSPORT_FETCH = '[Request] Passport fetch'
...
export const passportQuery = (userId: string, version?: number) => action(PASSPORT_QUERY, { userId, version })
export const passportFetch = (userId: string) => action(PASSPORT_FETCH, { userId })
...
export type PassportQueryAction = ReturnType<typeof passportQuery>
export type PassportFetchAction = ReturnType<typeof passportFetch>
