...
export function* handleFetchProfile(action: PassportRequestAction): any {
  ...
  try {
    ...
    profile.inventory = [
      'dcl://base-exclusive/bird_mask',
      'dcl://base-exclusive/classic_mask',
      'dcl://base-exclusive/clown_nose',
      'dcl://base-exclusive/asian_fox',
      'dcl://base-exclusive/killer_mask',
      'dcl://base-exclusive/Serial_killer_mask',
      'dcl://base-exclusive/theater_mask',
      'dcl://base-exclusive/tropical_mask',
      'dcl://halloween_2019/bride_of_frankie_earring',
      'dcl://halloween_2019/bee_suit_earring',
      'dcl://halloween_2019/jester_earring',
      'dcl://halloween_2019/spy_suit_eyewear',
      'dcl://halloween_2019/bee_suit_feet',
      'dcl://halloween_2019/bride_of_frankie_feet',
      'dcl://halloween_2019/creepy_nurse_feet',
      'dcl://halloween_2019/jester_feet',
      'dcl://halloween_2019/spy_suit_feet',
      'dcl://halloween_2019/witch_feet',
      'dcl://halloween_2019/sad_clown_feet',
      'dcl://halloween_2019/dracula_feet',
      'dcl://halloween_2019/frankie_feet',
      'dcl://halloween_2019/skeleton_suit_feet',
      'dcl://halloween_2019/zombie_suit_feet',
      'dcl://halloween_2019/bride_of_frankie_hair',
      'dcl://halloween_2019/jester_hair',
      'dcl://halloween_2019/spy_suit_hair',
      'dcl://halloween_2019/dracula_hair',
      'dcl://halloween_2019/creepy_nurse_hat',
      'dcl://halloween_2019/witch_hat',
      'dcl://halloween_2019/frankie_hat',
      'dcl://halloween_2019/mexican_hat',
      'dcl://halloween_2019/mariachi_hat',
      'dcl://halloween_2019/classic_top_hat',
      'dcl://halloween_2019/skeleton_suit_hat',
      'dcl://halloween_2019/creepy_pumpkin_helmet',
      'dcl://halloween_2019/happy_pumpkin_helmet',
      'dcl://halloween_2019/undead_pirate_helmet',
      'dcl://halloween_2019/bee_suit_lower_body',
      'dcl://halloween_2019/bride_of_frankie_lower_body',
      'dcl://halloween_2019/creepy_nurse_lower_body',
      'dcl://halloween_2019/jester_lower_body',
      'dcl://halloween_2019/spy_suit_lower_body',
      'dcl://halloween_2019/witch_lower_body',
      'dcl://halloween_2019/sad_clown_lower_body',
      'dcl://halloween_2019/dracula_lower_body',
      'dcl://halloween_2019/frankie_lower_body',
      'dcl://halloween_2019/skeleton_suit_lower_body',
      'dcl://halloween_2019/undead_pirate_lower_body',
      'dcl://halloween_2019/zombie_suit_lower_body',
      'dcl://halloween_2019/jester_mask',
      'dcl://halloween_2019/cat_mask',
      'dcl://halloween_2019/sad_clown_mask',
      'dcl://halloween_2019/muzzle_mask',
      'dcl://halloween_2019/funny_skull_mask',
      'dcl://halloween_2019/monkey_skull_mask',
      'dcl://halloween_2019/zombie_suit_mask',
      'dcl://halloween_2019/floral_skull_mask',
      'dcl://halloween_2019/lirio_skull_mask',
      'dcl://halloween_2019/trippy_skull_mask',
      'dcl://halloween_2019/diamond_skull_mask',
      'dcl://halloween_2019/rose_skull_mask',
      'dcl://halloween_2019/star_skull_mask',
      'dcl://halloween_2019/cross_skull_mask',
      'dcl://halloween_2019/bee_suit_top_head',
      ...
      'dcl://halloween_2019/jester_upper_body',
      'dcl://halloween_2019/spy_suit_upper_body',
      'dcl://halloween_2019/witch_upper_body',
      'dcl://halloween_2019/sad_clown_upper_body',
      'dcl://halloween_2019/dracula_upper_body',
      'dcl://halloween_2019/frankie_upper_body',
      'dcl://halloween_2019/skeleton_suit_upper_body',
      'dcl://halloween_2019/undead_pirate_upper_body',
